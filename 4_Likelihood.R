...
model1 <- glm(Survived ~ 1 , family = "binomial", data = titanic)
model2 <- glm(Survived ~ Cabin, family = "binomial", data = titanic)
model3 <- glm(Survived ~ Pclass+Fare, family = "binomial", data = titanic)
...
?model.sel
model.sel(model1, model2, model3)
